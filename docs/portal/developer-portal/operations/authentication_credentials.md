...
Before you configure Slingshot Host Software (SHS), obtain and save the authentication credentials needed for the configuration management Git repository of the system.
