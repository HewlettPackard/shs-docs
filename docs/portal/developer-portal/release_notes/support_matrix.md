...
The 200Gbps NIC firmware image version 1.5.56 is included in the Slingshot SHS 12.0.1 release. There are two firmware images contained in the slingshot-firmware-cassini-1.5.56-SSHOT\* RPM file:

```screen
cassini_fw_1.5.56.bin : Standard 200Gbps NIC firmware image
cassini_fw_esm_1.5.56.bin : Extended Speed Mode (ESM) 200Gbps NIC firmware image used exclusively on HPE Cray EX235a compute blade
```
