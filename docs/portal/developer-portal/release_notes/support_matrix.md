...
|  SHS Version   | FM/SA Version | FM/SA Version | FM/SA Version | FM/SA Version | FM/SA Version |
|:--------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
|                |   **2.1.3**   |   **2.2.0**   |   **2.3.0**   |   **2.3.1**   |   **3.0.0**   |
|   **2.1.3**    |     R-A-B     |   Supported   |   Supported   |   Supported   |   Supported   |
|   **2.2.0**    | Supported\*\* |     R-A-B     |   Supported   |   Supported   |   Supported   |
| **SHS-11.0.2** | Supported\*\* |   Supported   |   Supported   |   Supported   |   Supported   |
| **SHS-11.1.0** | Supported\*\* |   Supported   |   Supported   |   Supported   |   Supported   |
| **SHS-12.0.1** | Incompatible  |   Supported   |   Supported   |   Supported   |   Supported   |
| **SHS-12.0.2** | Incompatible  |   Supported   |   Supported   |   Supported   |   Supported   |
| **SHS-13.0.0** | Incompatible  |   Supported   |   Supported   |     R-A-B     |   Supported   |
...
| Red Hat Enterprise Linux | 9.6      | 6.4.0        | 570.124.06          | 25.05      |
| Red Hat Enterprise Linux | 9.6 ARM  | NA           | 570.124.06          | 25.05      |
...
| SuSE Linux Enterprise 15 | SP7      | 6.4.0        | 570.124.06          | 25.05      |
| SuSE Linux Enterprise 15 | SP7 ARM  | NA           | 570.124.06          | 25.05      |
...
| Red Hat Enterprise Linux | 9.6      | Yes          | 24.10-1.1.4.0    | Yes                          |
| Red Hat Enterprise Linux | 9.6 ARM  | No           | Not Supported    | Yes                          |
...
| SuSE Linux Enterprise 15 | SP7      | Yes          | 24.10-1.1.4.0    | Yes                          |
| SuSE Linux Enterprise 15 | SP7 ARM  | No           | Not Supported    | Yes                          |

SHS does not provide the Mellanox RPMs. Download the required software from the URLs listed below.
...
| HPE Performance Cluster Manager (HPCM) | 1.11, 1.12, 1.13, 1.14 |
