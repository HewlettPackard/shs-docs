...
QUERY_FILTERS = { NS_NEW_FEATURES     : 'filter = shs-v12.0.1-release-notes-feature-complete',
                  NS_RESOLVED_ISSUES  : 'filter = SHS-v12.0.1-Release-Notes-Resolved-Issues',
                  ...
                  NS_SUMMARY          : 'filter = SHS-v12.0.1-release-notes-summary' }
